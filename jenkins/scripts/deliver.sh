...
set +x
# Use options "-keystore $keystore -keystorepwd $password -keyalias jenkins" to use client certificate authentication with signclient (the alias jenkins should be the alias used in the keystore you configure as credentials)
